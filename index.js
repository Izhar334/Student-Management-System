...
class StudentManager {
    ...
    viewStudentBalance(studentId) {
        ...
        if (student) {
            ...
            console.log(chalk.red.italic("student not found. please enter a correct student ID"));
        }
    }
...
async function main() {
    console.log(chalk.gray.bold("\t\tWell come to Izhar's Student Managment System\t"));
